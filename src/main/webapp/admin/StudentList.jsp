...
<!-- <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search"> -->
	...
	<table border = "5px" align="center" bgcolor="#8FBC8F" class="table table-striped">
		...
		<tr>
			...
			<td><%=studentBean.getSid() %>
			<td><%=studentBean.getSfname() %>&nbsp;<%=studentBean.getSmname() %>&nbsp;<%=studentBean.getSlname() %>
			<td><%=studentBean.getSemail()%></td>
			<td><%=studentBean.getSpassword()%></td>
			<td><%=studentBean.getSdob() %></td>
			<td><%=studentBean.getSgender()%></td>
			<td><%=studentBean.getSphone() %></td>
						
			<td><center><a class="delete" href = "./DeleteStudentController?sid=<%=studentBean.getSid()%>" style="text-decoration:none">   DELETE  </a></center></td>
		  	<td><center><a class="update" href = "./EditStudentController?sid=<%=studentBean.getSid()%>" style="text-decoration:none">   UPDATE   </a></center></td>
		</tr>
	...
	<br>
	<center><a class="add" href = "admin/AddStudentPage.jsp" style="text-decoration:none" border="1px"><B>Add More</a></center>
	<br><br><br>
