...
<div class= "iphone"><input type="number" name="id" placeholder="ID" size="10" value="${facultyBean.fid }" readonly>   </div>
  
  <label> Firstname :</label> ${nameError } 
<input type="text" name="firstname" placeholder= "Firstname" size="15" value="${facultyBean.ffname}" required />   
...
<input type="text" name="lastname" placeholder="Lastname" size="15" value="${facultyBean.flname}" required />   
...
<select name = "subject">
						<option value = "0">Assign COURSE</option>
						...
						%>
						<option value = "<%=subjectBean.getSub_id()%>"><%=subjectBean.getSub_name()%></option>
						<%	
							}
						%>
...
<label>   
  ...
  <br>
  <div>
    <input class="form-control" type="date" name="dob" value="${facultyBean.fdob }" id="example-date-input" min="1997-01-01" max="2003-12-31">
  </div>
</div>  
...
<div class= "iphone"><input type="text" name="phone" placeholder="phone no." size="10" value="${facultyBean.fphone }" required>   </div>
...
<textarea cols="80" rows="5" placeholder="Current Address" value="address" required>   -->
 ...
 <input type="text" placeholder="Enter Email" name="email" value="${facultyBean.femail}" required>  
